...
class CreateKnowledgeSortModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('knowledge_sort', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->comment('知识库分类名称');
    ...
    {
        Schema::dropIfExists('knowledge_sort');
    }
}
