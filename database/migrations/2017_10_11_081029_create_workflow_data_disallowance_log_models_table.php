...
class CreateWorkflowDataDisallowanceLogModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('workflow_data_disallowance_log', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('workflow_data_disallowance_log');
    }
}
