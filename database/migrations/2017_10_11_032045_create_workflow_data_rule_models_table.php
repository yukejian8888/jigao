...
class CreateWorkflowDataRuleModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('workflow_data_rule', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('workflow_data_rule');
    }
}
