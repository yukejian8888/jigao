...
var htmlMinifier = function htmlMinifier(source, options) {
    if (detectNode) {
        ...
        var _htmlMinifier = __webpack_require__(20).minify;
...
var Compiler = function () {
    ...
    Compiler.prototype.build = function build() {
        ...
        var toMap = function toMap(line, script) {
            map.push({
                generated: {
                    line: line,
                    start: 0
        ...
        stacks.push('var ' + context.map(function (_ref) {
            var name = _ref.name,
                value = _ref.value;
            return name + '=' + value;
        }).join(','));
        ...
        if (options.compileDebug) {
            ...
            stacks.push('throw {' + ['path:' + stringify(filename), 'name:\'RuntimeError\'', 'message:error.message', 'line:' + LINE + '[0]+1', 'start:' + LINE + '[1]+1', 'source:' + LINE + '[2]', 'stack:error.stack'].join(',') + '}');
