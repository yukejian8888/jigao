                ...
                <div class="box-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{route('u_album_pic.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;上传图片</a>&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <button type="button" class="btn btn-box-tool" data-toggle="tooltip" title="编辑" data-widget="chat-pane-toggle">
                                            <a href="{{route('u_album_sort.edit',['id'=>$v['id']])}}">
                                            <i class="fa fa-edit"></i>
                                            </a>
                                        </button>
                                        <button type="button" class="btn btn-box-tool dogo-click-delete" title="删除文件夹"  data-url="{{route('u_album_sort.destroy',['id'=>$v['id']])}}" data-title="{{$v->name}}" data-id="{{$v->id}}"><i class="fa fa-times"></i>
                                        </button>
                                    </div>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <a href="{{route('u_album_pic.index',['sort_id'=>$v['id']])}}">
                                    <div class="dogo-pic-fengmian">
                                        {!! Html::image('style/user/images/icon_folder_gray.png') !!}
                                    </div>
                                    </a>
                                ...
                                <div class="box dogo-album-box box-warning ">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools pull-right">
                                            ...
                                            <button type="button" class="btn btn-box-tool dogo-click-delete" title="删除图片"  data-url="{{route('u_album_pic.destroy',['id'=>$v['id']])}}" data-title="{{$v->title}}" data-id="pic-{{$v->id}}"><i class="fa fa-times"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <!-- /.box-header -->
