        ...
        <nav data-sidebar-anyclick-close="" class="sidebar">
            ...
            <ul class="nav">
                        ...
                        <div class="item user-block">
                            ...
                            <div class="user-block-picture">
                                <div class="user-block-status">
                                    <img src="{{asset('vendor/angle/img/user/02.jpg')}}" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
                ...
                <li class="nav-heading">
                    <span data-localize="">项目管理系统</span>
                </li>
                @foreach (config('menu_admin.menu_list') as $k=>$v)
                <li class=" ">
                    <a href="#{{$v['type']}}" title="Dashboard" data-toggle="collapse">
                        <em class="{{$v['ico']}}"></em>
                        <span data-localize="sidebar.nav.DASHBOARD">{{$v['name']}}</span>
                    </a>
                    <ul id="{{$v['type']}}" class="nav sidebar-subnav collapse">
                        <li class="sidebar-subnav-header">Dashboard</li>
                        @foreach ($v['items'] as $sub_k=>$sub_v)
                        <li>
                            <a href="{{route($sub_v['route_name'],$sub_v['params'])}}" title="{{$sub_v['name']}}">
                                <span>{{$sub_v['name']}}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
