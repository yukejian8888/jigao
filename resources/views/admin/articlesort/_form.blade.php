...
{!! Html::script('plugins/easyui/local/easyui-lang-zh_CN.js') !!}
<div class="panel panel-default">
    ...
    <div class="box-body dogo-box-form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                {{--<input name="pid" class="form-control easyui-combotree combotree"
                       data-options="url:'{{route('sort_list_tree',['sort_name'=>'article_sort'])}}',required:true"
                       value="{{$pid}}" style="width:100%;height: 34px;">--}}
                {!! Form::select('pid',$articlesort,$pid,['class'=>'form-control']) !!}
                <span class="help-block m-b-none"></span>
            </div>
        </div>
        <div class="form-group">
