        ...
        <div class="box box-info">
            ...
            <div class="box-body dogo-box-form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('title', $title,['class'=>'form-control','placeholder'=>'分类名称']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="sort_id" class="form-control easyui-combotree combotree" data-options="url:'{{route('sort_list_tree',['sort_name'=>'ad_sort'])}}',required:true" value="{{$sort_id}}" style="width:100%;height: 34px;">
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
