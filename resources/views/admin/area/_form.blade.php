    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body dogo-box-form">
                ...
                <div class="form-group">
                    {!! Form::label('fortitle','拼音或者英文',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('pinyin', $pinyin,['class'=>'form-control','placeholder'=>'拼音或者英文']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('forsortid','所属地区',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::select('pid', $select, $pid, ['class'=>'form-control']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
