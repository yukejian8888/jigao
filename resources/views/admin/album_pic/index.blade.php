                    ...
                    <div class="box-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <a href="{{route('album_pic.create',['sort_id'=>$sort_id])}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;上传图片</a>&nbsp;&nbsp;&nbsp;
                                <a href="{{route('album_sort.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;新建文件夹</a>
                                <a href="{{route('album_sort.index')}}" class="btn btn-info btn-sm"><i class="fa fa-list"></i>&nbsp;返回相册</a>
                            </div>
                                    ...
                                    <div class="box dogo-album-box box-warning ">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="box-tools pull-right">
                                                ...
                                                <button type="button" class="btn btn-box-tool dogo-click-delete" title="删除图片"  data-url="{{route('album_pic.destroy',['id'=>$v['id']])}}" data-title="{{$v->title}}" data-id="{{$v->id}}"><i class="fa fa-times"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <!-- /.box-header -->
