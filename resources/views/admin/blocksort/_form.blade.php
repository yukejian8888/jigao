        ...
        <div class="box box-info">
            ...
            <div class="box-body dogo-box-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="pid" class="form-control easyui-combotree combotree" data-options="url:'{{route('sort_list_tree',['sort_name'=>'block_sort'])}}',required:true" value="{{$pid}}" style="width:100%;height: 34px;">
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
