        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input name="sort_id" class="form-control easyui-combotree combotree" data-options="url:'{{route('sort_list_tree',['sort_name'=>'brand_sort'])}}',required:true" value="{{$sort_id}}" style="width:100%;height: 34px;">
                </div>
                <div class="form-group">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <span class="dogo-tip">信息提示说明</span>
                </div>
                <div class="form-group">
