...
@section('content')
        ...
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="panel widget bg-purple">
                <div class="row row-table">
                    ...
                    <div class="col-xs-8 pv-lg">
                        <div class="h2 mt0">
                            <a href="javascript:void(0);" class="ly-js-check-in">签到</a>
                            <small>GB</small>
                        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="panel widget bg-green">
                <div class="row row-table">
                    ...
                    <div class="col-xs-8 pv-lg">
                        <div class="h2 mt0">
                            <a href="javascript:void(0);" class="ly-js-check-out">签退</a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div data-height="180" data-scrollable="" class="list-group">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-box">
                                    <div class="pull-left">
                                        <img src="{{asset('vendor/angle/img/user/02.jpg')}}" alt="Image"
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-box">
                                    <div class="pull-left">
                                        <img src="{{asset('vendor/angle/img/user/03.jpg')}}" alt="Image"
                                             class="media-box-object img-circle thumb32">
                                    </div>
                                    <div class="media-box-body clearfix">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-box">
                                    <div class="pull-left">
                                        <img src="{{asset('vendor/angle/img/user/09.jpg')}}" alt="Image"
                                             class="media-box-object img-circle thumb32">
                                    </div>
                                    <div class="media-box-body clearfix">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-box">
                                    <div class="pull-left">
                                        <img src="{{asset('vendor/angle/img/user/12.jpg')}}" alt="Image"
                                             class="media-box-object img-circle thumb32">
                                    </div>
                                    <div class="media-box-body clearfix">
                                        <small class="pull-right">1d</small>
                                        <strong class="media-box-heading text-primary">
                                            <span class="circle circle-danger circle-lg text-left"></span>Rosa
                                            Burke</strong>
                                        <p class="mb-sm">
                                            <small>Cras sit amet nibh libero, in gravida nulla. Nulla...</small>
                                        </p>
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-box">
                                    <div class="pull-left">
                                        <img src="{{asset('vendor/angle/img/user/10.jpg')}}" alt="Image"
                                             class="media-box-object img-circle thumb32">
                                    </div>
                                    <div class="media-box-body clearfix">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".ly-js-check-in").click(function(){
                $.ajax({
                    url     :"{{route('admin.attendance.punch')}}",
                    type    : "post",
                    dataType : "json",
                    data    : "",
                    headers: {
            ...
            //签退
            $(".ly-js-check-out").click(function(){
                $.ajax({
                    url     :"{{route('admin.attendance.checkout')}}",
                    type    : "post",
                    dataType : "json",
                    data    : "",
                    headers: {
