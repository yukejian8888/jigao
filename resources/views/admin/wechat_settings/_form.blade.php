    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                微信绑定地址：{{route('wechat_server')}}
                微信授权回调地址：{{route('oauth_callback')}}
            </div>
            <!-- /.box-header -->
            <div class="box-body  dogo-box-form">
                <div class="form-group">
                    {!! Form::label('fortitle','微信名称',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('name', $name,['class'=>'form-control','placeholder'=>'微信名称']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('fortitle','微信号',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('number', $number,['class'=>'form-control','placeholder'=>'微信号']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('forkey','APP_ID',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('app_id', $app_id,['class'=>'form-control','placeholder'=>'app id']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    {!! Form::label('forsecret','token',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('token', $token,['class'=>'form-control','placeholder'=>'token']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('forsecret','aes_key',['class'=>'col-sm-2 control-label']) !!}
                    <div class="col-sm-9">
                        {!! Form::text('aes_key', $aes_key,['class'=>'form-control','placeholder'=>'aes_key']) !!}
                        <span class="dogo-tip"></span>
                    </div>
                </div>
                <div class="form-group">
